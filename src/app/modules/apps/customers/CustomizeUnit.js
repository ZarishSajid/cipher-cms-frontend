      ...
      <div>
        <ul className='nav nav-tabs nav-line-tabs mb-5 fs-6'>
          <li className='nav-item'>
            ...
            <Link to='/apps/customers/AddCustomers'><h6 className='text-primary'> Customer Details</h6></Link>
            </a>
          </li>
          <li className='nav-item'>
            <a className='nav-link'  >
             <Link to='/apps/customers/Accounting' ><h6 className='text-primary'> Accounting</h6></Link>
            </a>
          </li>
          <li className='nav-item'>
            <a className='nav-link'  >
            <Link to='/apps/customers/CustomerContact'><h6 className='text-primary'> Contact Contact Details</h6></Link>
            </a>
          </li>
          <li className='nav-item active'>
            <a className='nav-link' >
             <Link to='/apps/customers/CustomizeUnit'> <h6 className='text-primary'> Customize Units</h6></Link>
            </a>
          </li>
        </ul>
            ...
            <div className='w-100'>
              ...
              >
                ...
                <div className='d-flex flex-stack pt-15'>
                  <div className='mr-2'>
                  <Link to='/apps/customers/CustomerContact'>  <button
                      type='button'
