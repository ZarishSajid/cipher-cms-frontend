...
class UsersList extends React.Component <any,any> {
  ...
  handleRole(e:React.ChangeEvent<HTMLInputElement>) {
                            ...
                            >
                              <div className='fv-row mb-7'>
                                ...
                                <div
                                  ...
                                  style={{
                                    backgroundImage:
                                      'url(/metronic8/demo1/assets/media/avatars/blank.png)',
                                  }}
                                >
                                  <div
                                    ...
                                    style={{
                                      backgroundImage:
                                        'url(/metronic8/demo1/assets/media/avatars/150-1.jpg)',
                                    }}
                                  ></div>
                              ...
                              <div className='radio'>
                                <input
                                  ...
                                  type='radio'
                                  value='Developer'
                                  checked={this.state.selectedOption === 'Developer'}
                                  onChange={this.onValueChange}
                                />
                              ...
                              <div className='radio'>
                                <input
                                  ...
                                  type='radio'
                                  value='Analyst'
                                  checked={this.state.selectedOption === 'Analyst'}
                                  onChange={this.onValueChange}
                                />
